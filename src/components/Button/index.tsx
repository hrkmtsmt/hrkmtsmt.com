...
const Component: React.VFC<Props> = props => {
  const selectButtonColor = (selectColor: SelectColor) => {
    const primaryColor = 'bg-primary text-white before:bg-secondary hover:bg-secondary hover:text-primary';
    if (selectColor === 'primary') return primaryColor;
    const secondaryColor = 'bg-secondary text-primary before:bg-primary hover:bg-secondary hover:text-white';
